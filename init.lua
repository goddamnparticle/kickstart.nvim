...
require('lazy').setup({
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        extensions = {
          ...
          ['conda'] = { conda_path = '/home/yorek/python/miniconda3' },
        },
      }
      ...
      -- vim.keymap.set('n', '<leader>pe', '<cmd>Telescope conda<CR>', { desc = '[ ] Find existing buffers' })
      vim.keymap.set('n', '<leader>pe', function()
        require('telescope').extensions.conda.conda { require('telescope.themes').get_dropdown() }
      end, { desc = 'Change Conda Environment' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map(';s', require('telescope.builtin').lsp_document_symbols, 'Open Document Symbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map(';S', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Open Workspace Symbols')
  ...
  {
    'goddamnparticle/telescope-conda.nvim',
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    lazy = false,
    config = function()
      local ensure_installed = { 'bash', 'c', 'python', 'cpp', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' }
