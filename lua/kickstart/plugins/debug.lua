...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', ',w', require('dapui').elements.watches.add, { silent = true })
    ...
    dap.configurations.python = {
      {
        ...
        pythonPath = function()
          ...
          elseif vim.env.CONDA_PREFIX and vim.fn.executable(vim.env.CONDA_PREFIX .. '/bin/python') == 1 then
